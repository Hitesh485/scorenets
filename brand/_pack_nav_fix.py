...
for p in ROOT.rglob("*.html"):
    ...
    if "auth.js?v=" not in t and "boot.js?v=" not in t and "brand.css?v=" not in t:
        continue
    t2 = t
...
tar_path = ROOT / "_sn_nav_fix_deploy.tar"
with tarfile.open(tar_path, "w") as tar:
    for rel in ["brand/auth.js", "brand/boot.js", "brand/brand.css"]:
