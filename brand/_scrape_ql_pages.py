"""Scrape all Quick Links Sofascore destinations into ScoreNet shells."""
...
OUT_META = ROOT / "_sn_ql_pages_build.json"
VER = "20260907ql"
...
def main():
    ...
    with sync_playwright() as p:
        ...
        for route, out_rel in PAGES:
            ...
            is_403 = len(html) < 2000 and "Forbidden" in html
            print(
                "TITLE",
                title[:80],
                "bad",
            ...
            if is_404 or is_403:
                results.append({"route": route, "error": "blocked", "title": title, "bytes": len(html)})
                continue
